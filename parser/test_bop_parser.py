...
def test_parser():
    ...
    parser.add_argument('--savepath', type=str, default='log/test/Try10/OWID_0',
                        help='Path for checkpoints and logs')
    parser.add_argument('--resume', type=str, default='log/train_local/Try10/OWID_0/checkpoint.tar',
